...
This chapter discussed details about the concrete implementation of concepts and components presented in \autoref{ch:concept_design}. The resulting software system is subsequently evaluated in \autoref{ch:evaluation} and constitutes a proof-of-concept for a novel, holistic cooperative perception system.
